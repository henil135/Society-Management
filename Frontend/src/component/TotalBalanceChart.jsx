...
function TotalBalanceChart() {
    ...
    //     const [contacts, setContacts] = useState([]); // State for contacts data
    //     const [show, setShow] = useState(false); // State for add/edit modal
    ...
    //             try {
    //                 const response = await axios.get('http://localhost:5000/api/v2/important-numbers/'); // Replace with your API endpoint
    ...
    //             try {
    //                 const response = await axios.put(`http://localhost:5000/api/v2/important-numbers/${contacts[editIndex].id}`, newContact); // Replace with your endpoint for updating contacts
    //                 setContacts(contacts.map((contact, index) => (index === editIndex ? response.data : contact)));
    //             } catch (error) {
    ...
    //             // Add new contact
    //             try {
    //                 const response = await axios.post('http://localhost:5000/api/v2/important-numbers/create', newContact); // Replace with your endpoint for creating contacts
    ...
    //         if (deleteIndex !== null) {
    //             try {
    //                 await axios.delete(`http://localhost:5000/api/v2/important-numbers/${contacts[deleteIndex].id}`); // Replace with your endpoint for deleting contacts
